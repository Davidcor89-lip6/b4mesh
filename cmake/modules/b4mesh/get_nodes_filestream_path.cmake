...
function (get_nodes_filestream_path SOURCES_PATH)
    ...
    if (NOT EXISTS ${SOURCES_PATH})
        message(FATAL_ERROR "get_nodes_filestream_path : `SOURCES_PATH` does not exists (set to ${SOURCES_PATH})")
    endif()

    set(filestream_path_regex ".*LIVEBLOCK_FILE\ *\=?\ *.*\"(.+)\"")
    set(target_file ${SOURCES_PATH}/core_engine/includes/impl/b4mesh/core_engine/configs.hpp)
    file(STRINGS
        ${target_file}
        result
