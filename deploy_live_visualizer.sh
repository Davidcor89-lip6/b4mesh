...
do
    ...
    sshpass -p 'b4meshroot' scp     live_visualizer/live_visualizer.html    default@$addr:/var/persistent-data/b4mesh/tmp/
    sshpass -p 'b4meshroot' scp     live_visualizer/style.css               default@$addr:/var/persistent-data/b4mesh/tmp/
    sshpass -p 'b4meshroot' scp     live_visualizer/favicon.ico             default@$addr:/var/persistent-data/b4mesh/tmp/
    sshpass -p 'b4meshroot' scp -r  live_visualizer/scripts/                default@$addr:/var/persistent-data/b4mesh/tmp/
    ...
    sshpass -p 'b4meshroot' ssh default@$addr "echo -e \"location /blockgraph_live_visualizer/view {\n \
        ...
        alias live_visualizer/live_visualizer.html;\n       \
    }\n                                                     \
