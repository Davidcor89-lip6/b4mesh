...
do
    ...
    sshpass -p 'b4meshroot' scp live_visualizer/ default@$addr:/var/persistent-data/b4mesh/tmp/
    sshpass -p 'b4meshroot' scp deploy/ default@$addr:/var/persistent-data/b4mesh/tmp/
done
