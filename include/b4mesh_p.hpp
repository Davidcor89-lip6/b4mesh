...
class B4Mesh
{
    ...
    // this added
       void WriteInfoFile2sec();

        void WriteInfoFile7sec();

        void WriteInfoFile30sec();
    ...
    private:
        ...
        void timer_recurrentTask1sec_fct (const boost::system::error_code& /*e*/);
        boost::asio::steady_timer timer_recurrentTask1sec;

        void timer_recurrentTask7sec_fct (const boost::system::error_code& /*e*/);
        boost::asio::steady_timer timer_recurrentTask7sec;

        void timer_recurrentTask30sec_fct (const boost::system::error_code& /*e*/);
        boost::asio::steady_timer timer_recurrentTask30sec;
};
